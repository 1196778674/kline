...
(function (KLineChart) {
  ...
  chart_mainCanvas.style.cssText = `cursor:default;overflow:hidden;position:absolute;z-index:0;left:0;top:0;`;
  chart_overlayCanvas.style.cssText = `cursor:default;overflow:hidden;position:absolute;z-index:2;left:0;top:0;`;
  ...
  var GLOBAL_VAR = {
    ...
    button_down: false,
    init: false,
    fixedNumber: opts.fixedNumber || 2,
  ...
  DarkTheme.prototype.__construct = function() {
    this._colors = [];
    this._colors[Theme.Color.Positive] = "#3399ff"; // #ff6203
    this._colors[Theme.Color.Negative] = "#33cc66"; // #44ea37
    this._colors[Theme.Color.PositiveDark] = "#3399ff";
    this._colors[Theme.Color.NegativeDark] = "#33cc66";
    this._colors[Theme.Color.Unchanged] = "#fff";
    this._colors[Theme.Color.Background] = "#fff"; //"#080808"
    this._colors[Theme.Color.Cursor] = "#aaa";
    this._colors[Theme.Color.RangeMark] = "#f9ee30";
    this._colors[Theme.Color.Indicator0] = "#888"; //#ddd
    ...
    this._colors[Theme.Color.Grid0] = "#efefef"; //#333
    ...
    this._colors[Theme.Color.TextPositive] = "#3399ff";
    this._colors[Theme.Color.TextNegative] = "#33cc66";
    this._colors[Theme.Color.Text0] = "#2B2929";
    this._colors[Theme.Color.Text1] = "#666";
    this._colors[Theme.Color.Text2] = "#888";
    this._colors[Theme.Color.Text3] = "#333";
    this._colors[Theme.Color.Text4] = "#333"; //#ccc
  ...
  TimelinePlotter.prototype.Draw = function(b) {
    ...
    if (j.length > 0) {
      ...
      let ss = [j[0]]
      while (ss[ss.length - 1].x + width < z.getRight() - 88) {
        ss.push({
  ...
  RangeSelectionPlotter.prototype.Draw = function(b) {
    ...
    Plotter.createPolygon(b, [{x: a.getLeft(), y: g}, {x: a.getLeft() + 5, y: g + 10}, {x: a.getRight() - 3, y: g + 10}, {x: a.getRight() - 3, y: g - 10}, {x: a.getLeft() + 5, y: g - 10}]);
